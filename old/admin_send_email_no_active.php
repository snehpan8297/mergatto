...
<div id='content'>
	...
	<div id='page_header'>
		<div id='page_navigator'>
			<a href='./admin_menu.php'><?php echo $s["admin_menu_title"];?></a> / <a href='#' class='important'>Newsletter no Activos</a>
		</div>
	</div>
...
plugins: [
    ...
    relative_urls: false
		...
		<div class='form' id="signup_step_1" style="display:block">
			<form id='step_1' action="./admin_send_email_no_active.php" method="post" autocomplete='off'>
