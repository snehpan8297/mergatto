...
/*		
if(($page!="admin")&&(!isset($_SESSION["admin_classics"]))){
...
<?php 
	...
	include('./theme/styles_sales.php');
?>
...
?>
	...
	<?php
			?>
			<div id='top_menu'>
				<div class='user_panel' style='color:white !important'>
						<?php
					if(isset($_SESSION['user_classics']['id_client'])){
						...
						echo "<a class='' style='color:white !important' href='my_account.php'>".$s["my_account"]."</a> | <a style='color:white !important' href='./logout.php' class=''>".$s["logout"]."</a> ";
		
					}else if(isset($_SESSION['admin_classics'])){
						echo $s["header_hello_admin"]." <span class='important'>|</span> <a href='./admin_menu.php' class='important' style='color:white !important'>".$s["admin_menu"]."</a> <span class='important'>|</span> <a href='./admin_logout.php' class='important' style='color:white !important'>".$s["logout"]."</a> ";
					}else{
						if((!isset($page_title))||(empty($page_title))){
							$page_title="pagina desconocida";
						}
						...
						$data["action"]="esta viendo "."<b>".$page_title_log."</b>";
						addInBD($table,$data);
						echo "<a href='./login.php' style='color:white !important'>".$s["login"]."</a> | <a href='./signup.php' style='color:white !important'>".$s["signup"]."</a> ";
					}
				?>
	<?php
		...
		<a href='./cart.php' class='important icon_cart' style='color:white !important'><i class='fa fa-shopping-cart'></i> <?php echo "( <span id='numtotal'>".$numtotal."</span> ) <span id='moneytotal'>".$moneytotal."</span> ".$c['symbol']."  "; ?>
			<?php
		...
		<a href='./cart.php' class='btn btn-mini btn-white'><?php echo $s["finish_order"];?></a>
		</div>
	<?php
			}
	?>
				</div>
				<a href='http://www.okycoky.net/classics' class='logo'><img src='./img/interface/okycoky-logo-sales.png'/></a>
<form id='search' action='search.php' method='get' style='margin-bottom:40px;margin-top:10px;'/>
		...
		<div style='margin-left:50px;margin-top:-5px;font-size:12px;color:white'>
			<?php echo $s["customer_care"];?>: <i class='fa fa-phone'></i> 986 240 001 <i class='fa fa-envelope-o'></i> shop@okycoky.com
		</div>
			</div>
