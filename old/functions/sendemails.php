...
$_POST["content"]=str_replace('src="/classics/news', 'src="http://www.okycoky.net/classics/news', $_POST["content"]);

$_POST["content"]=str_replace('img style="', 'img style="width:100%;', $_POST["content"]);
$_POST["content"]=str_replace('img src="', 'img style="width:100%" src="', $_POST["content"]);

$_POST["content"]=str_replace('href="/', 'href="http://www.okycoky.net/', $_POST["content"]);
...
error_log("[Classsics] Newsletter enviando START (".$_POST["email"].")");
mail($_POST["email"],'Oky^Coky - '.$_POST["title"],$mail_content,"Content-type: text/html\r\nFrom:Oky^Coky Shop<sales@okycoky.com>");
error_log("[Classsics] Newsletter enviando OK (".$_POST["email"].")");
