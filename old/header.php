...
?>
			...
			<div id='top_menu'>
				<div class='user_panel'>
					...
					if(isset($_SESSION['user_classics']['id_client'])){
						...
						echo "<a class='' href='my_account.php'>".$s["my_account"]."</a> | <a href='./logout.php' class=''>".$s["logout"]."</a> ";
						...
						$data["action"]="esta viendo "."<b>".$page_title_log."</b>";
						addInBD($table,$data);
						echo "<a href='./login.php' class='text-dark'>".$s["login"]."</a> | <a href='./signup.php' class=''>".$s["signup"]."</a> ";
					}
				?>
	<?php
		...
		<a href='./cart.php' class='important icon_cart'><i class='fa fa-shopping-cart'></i> <?php echo "( <span id='numtotal'>".$numtotal."</span> ) <span id='moneytotal'>".$moneytotal."</span> ".$c['symbol']."  "; ?>
			<?php
	...
	?>
				...
				<a href='http://www.okycoky.net/classics' class='logo'><img src='./img/interface/okycoky-logo.png'/></a>
<form id='search' action='search.php' method='get' style='margin-bottom:40px;margin-top:10px;'/>
		...
		<div style='margin-left:50px;margin-top:-5px;font-size:12px;'>
