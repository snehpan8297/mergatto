				...
				<tr>
					...
					<td style='text-align:right;width:330px;'>
						<div style='border:1px solid #666;width:355px;padding:10px;'>
							...
							?>
							<?php echo $return["invoice_address_name"];?> ( #W<?php echo $return["id_client"];?>-E<?php echo $client["id_elastic"];?>)<br>
			...
			<div class='contentbox'>
				...
				<form>
					...
					<div style='margin-right:30px;padding-top:10px'>
						Recibido aviso de Devolución: <a href="javascript:set_content('es','return');">Castellano</a> | <a href="javascript:set_content('en_1','return');">Inglés</a>
					</div>
					<div style='margin-right:30px;padding-top:10px'>
	...
	*/
	function set_content(lang,op){
		if(op=="wait_payment"){
			...
			if(lang=="es"){
				$("#email_content").val("Hola ,\nHemos recibido la devolución del vestido () y ya hemos abonado en la cuenta de tu tarjeta el importe pagado (€).\nPor favor, compruébalo en tu siguiente extracto.\nMuchas gracias.");
			}else{		
				$("#email_content").val("Hello ,\nWe have received the returned goods () and we have refunded the cost payed (€) on your credit card.\nPlease check it in your next bank statement.\nThank you.");
			}
		}else{
