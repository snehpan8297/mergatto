	...
	<div class='contentbox'>
		...
		<div class='form' style="display:block">
			<form id='step_1' action="./import_product.php" method="post">
				...
				<div class='form_entry'>
					<span class='label'>Categor&iacute;a <span class='form_isrequired'>*</span></span>
					<select name="id_category" id="id_category" class="select">
						<option value='0'>Sin categor&iacute;a</option>
						<?php
						foreach ($categories as $key=>$category){
							?>
							<option name='id_category' id='id_category' value='<?php echo $category["id_category"];?>'><?php echo $category["name_es"];?></option>
							<?php
						}
						?>
					</select>
