      ...
      if(response.result){
        ...
        if($_PAGE=="/shop/cart/"){
          ...
          jQuery.each(response.data.cart_items,function($_key,$_cart_item){
            ...
            $_ajax["cart-items-list"]+="  <td class='vert-align'>"+$_cart_item.size+"</td>";
            ...
            $_ajax["cart-items-list"]+="  <td class='text-center vert-align'><input type='number' min='1' max='9' class='form-control form-control-inline' style='width: 52px!important;' value='"+$_cart_item.quantity+"'></td>";
